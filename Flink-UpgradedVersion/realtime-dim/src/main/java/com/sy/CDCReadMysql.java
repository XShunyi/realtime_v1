...
import com.sy.func.Flinkcdc2Mysql;
...
//---------------------------------------------------------------------------------------------------------------------------------------------
        ...
        MySqlSource<String> stream = Flinkcdc2Mysql.getcdc2mysql(
...
// "ts_ms":1734919118113}
        ...
        // Read gmall_config
        MySqlSource<String> stream_config = Flinkcdc2Mysql.getcdc2mysql(
