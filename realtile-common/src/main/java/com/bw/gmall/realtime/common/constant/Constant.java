...
public class  Constant {
    ...
    public static final String HBASE_ZOOKEEPER_QUORUM = "hadoop102,hadoop104,hadoop103";
    ...
    public static final String TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS = "dwd_trade_refund_payment_success1";
